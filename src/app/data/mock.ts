...
export const INDICADORES: Indicador[] = [
  {
    label: 'Venta GP actual',
    valor: '$158,420',
    icon: 'trending',
    tone: 'brand',
    detalle: '56% de la meta C6',
  },
  {
    label: 'Activas GP',
    valor: '31',
  ...
  },
  {
    ...
    icon: 'chart',
    tone: 'danger',
    detalle: 'Riesgo · sin MRM ni PPED',
  },
  {
    ...
    icon: 'wallet',
    tone: 'warning',
    detalle: 'Meta PAR+: 3.00%',
  },
  {
    label: 'Crédito Yanbal',
    valor: '$10,820',
    icon: 'wallet',
    tone: 'info',
    detalle: 'de $14,000 disponibles',
  },
];
...
export const MATERIALES: Material[] = [
  {
    titulo: 'Carrera de Liderazgo',
    tag: 'Nuevo',
    gradiente: 'linear-gradient(160deg, #d94e15, #92330b)',
    emoji: '🚀',
  },
  {
    titulo: 'Ganamás C6',
    tag: 'Actual',
    gradiente: 'linear-gradient(160deg, #ddd0c0, #b8a68e)',
    emoji: '🏆',
  },
  {
    titulo: 'Catálogo C6',
...
export const HERRAMIENTAS: Herramienta[] = [
  {
    titulo: 'Product Book C6',
    categoria: 'Productos',
    subcategoria: 'Lanzamiento',
    gradiente: 'linear-gradient(150deg, #d94e15, #92330b)',
    emoji: '📖',
  },
  {
    titulo: 'Invitación Lanzamiento',
    categoria: 'Productos',
    subcategoria: 'Lanzamiento',
    gradiente: 'linear-gradient(150deg, #5b8c5a, #2f5233)',
    emoji: '💌',
  },
  {
    ...
    categoria: 'Productos',
    subcategoria: 'Lanzamiento',
    gradiente: 'linear-gradient(150deg, #ded6cb, #b8aa95)',
    emoji: '🎤',
  },
  {
    titulo: 'Ohm Black · Postal',
    categoria: 'Productos',
    subcategoria: 'Perfumería',
    gradiente: 'linear-gradient(150deg, #1e293b, #0f172a)',
    emoji: '🌑',
  },
  {
    titulo: 'Ohm Now · Postal',
    categoria: 'Productos',
    subcategoria: 'Perfumería',
    gradiente: 'linear-gradient(150deg, #3f6212, #65a30d)',
    emoji: '🌿',
  },
  {
    titulo: 'Ohm · Postal',
    categoria: 'Productos',
    subcategoria: 'Perfumería',
    gradiente: 'linear-gradient(150deg, #7da2c9, #b9d2ea)',
    emoji: '💧',
  },
  {
    titulo: 'PPT Reunión de Núcleo C6',
    categoria: 'Negocio',
    subcategoria: 'Lanzamiento',
    gradiente: 'linear-gradient(150deg, #c2410c, #ea580c)',
    emoji: '📊',
  },
  {
    titulo: 'Product Book · Demo',
    categoria: 'Negocio',
    subcategoria: 'Lanzamiento',
    gradiente: 'linear-gradient(150deg, #ea580c, #f97316)',
    emoji: '🎬',
  },
  {
    titulo: 'Sérum Gérmaine · Postal',
    categoria: 'Productos',
    subcategoria: 'Tratamiento Facial',
    gradiente: 'linear-gradient(150deg, #831843, #be185d)',
    emoji: '🧴',
  },
  {
    titulo: 'Oferta Dúo Perfecto',
    categoria: 'Ofertas',
    subcategoria: 'Maquillaje',
    gradiente: 'linear-gradient(150deg, #9d174d, #db2777)',
    emoji: '💋',
  },
  {
    titulo: 'Tabla de Ganancias C6',
    categoria: 'Ganancias',
    subcategoria: 'Lanzamiento',
    gradiente: 'linear-gradient(150deg, #166534, #16a34a)',
    emoji: '💰',
  },
  {
    ...
    categoria: 'Negocio',
    subcategoria: 'Lanzamiento',
    gradiente: 'linear-gradient(150deg, #1d4ed8, #3b82f6)',
    emoji: '🤝',
  },
];
...
export const DIRECTORAS: Directora[] = [
  // ---- Gen 1 · Hijas ----
  {
    ...
    faltaA: '',
    metas: {
      ventaGP: { real: 245700, meta: 230000 },
      activas: { real: 63, meta: 60 },
      pped: { real: 7, meta: 6 },
      reactivas: { real: 11, meta: 10 },
      retenidas: { real: 49, meta: 47 },
    },
  ...
  },
  {
    ...
    faltaA: '',
    metas: {
      ventaGP: { real: 212400, meta: 200000 },
      activas: { real: 58, meta: 55 },
      pped: { real: 6, meta: 5 },
      reactivas: { real: 9, meta: 8 },
      retenidas: { real: 44, meta: 42 },
    },
  ...
  },
  {
    ...
    faltaA: '',
    metas: {
      ventaGP: { real: 168900, meta: 160000 },
      activas: { real: 41, meta: 40 },
      pped: { real: 4, meta: 4 },
      reactivas: { real: 6, meta: 6 },
      retenidas: { real: 33, meta: 32 },
    },
  ...
  },
  {
    ...
    generacion: 1,
    cuadrante: 'C',
    faltaA: 'Cumple PPED · faltan $41.7k de venta (MRM)',
    metas: {
      ventaGP: { real: 98300, meta: 140000 },
      activas: { real: 27, meta: 38 },
      pped: { real: 4, meta: 4 },
      reactivas: { real: 2, meta: 6 },
      retenidas: { real: 22, meta: 31 },
    },
    emprendedoras: { cem: 0, ces: 0, nota: 'Sin emprendedoras aún' },
    par: { proyectada: 1, sueno: 3, falta: 'Cumplir el monto de venta del Sueño' },
  },
  {
    nombre: 'Rosa Maldonado',
    iniciales: 'RM',
    estatus: 'JNR',
    generacion: 1,
    cuadrante: 'D',
    faltaA: 'Faltan venta (MRM) y primeros pedidos',
    metas: {
      ventaGP: { real: 64100, meta: 135000 },
      activas: { real: 21, meta: 37 },
      pped: { real: 0, meta: 4 },
      reactivas: { real: 1, meta: 6 },
      retenidas: { real: 16, meta: 31 },
    },
  ...
  // ---- Gen 2 · Nietas ----
  {
    ...
    faltaA: '',
    metas: {
      ventaGP: { real: 142000, meta: 135000 },
      activas: { real: 36, meta: 34 },
      pped: { real: 4, meta: 3 },
      reactivas: { real: 5, meta: 5 },
      retenidas: { real: 27, meta: 26 },
    },
    emprendedoras: { cem: 1, ces: 0, nota: '1 CEM · aún sin CES' },
  ...
  },
  {
    ...
    generacion: 2,
    cuadrante: 'B',
    faltaA: 'Cumple venta (MRM) · faltan 2 primeros pedidos',
    metas: {
      ventaGP: { real: 121000, meta: 150000 },
      activas: { real: 32, meta: 40 },
      pped: { real: 2, meta: 4 },
      reactivas: { real: 4, meta: 7 },
      retenidas: { real: 26, meta: 33 },
    },
    emprendedoras: { cem: 1, ces: 0, nota: '1 CEM · aún sin CES' },
    par: { proyectada: 1, sueno: 2, falta: 'Subir a Cuadrante A' },
  },
  {
    nombre: 'Diana Cabrera',
    iniciales: 'DC',
    estatus: 'JNR',
    generacion: 2,
    cuadrante: 'D',
    faltaA: 'Faltan venta (MRM) y primeros pedidos',
    metas: {
      ventaGP: { real: 51200, meta: 130000 },
      activas: { real: 18, meta: 36 },
      pped: { real: 0, meta: 4 },
      reactivas: { real: 1, meta: 6 },
      retenidas: { real: 14, meta: 30 },
    },
    emprendedoras: { cem: 0, ces: 0, nota: 'Sin emprendedoras aún' },
  ...
  // ---- Gen 3 · Bisnieta ----
  {
    ...
    generacion: 3,
    cuadrante: 'C',
    faltaA: 'Cumple PPED · faltan $44k de venta (MRM)',
    metas: {
      ventaGP: { real: 76000, meta: 120000 },
      activas: { real: 22, meta: 35 },
      pped: { real: 4, meta: 4 },
      reactivas: { real: 1, meta: 5 },
      retenidas: { real: 18, meta: 30 },
    },
    emprendedoras: { cem: 0, ces: 0, nota: 'Sin emprendedoras aún' },
