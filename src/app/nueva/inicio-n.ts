...
import { CAMPANA, CREDITOS_PENDIENTES, USUARIA } from '../data/mock';
      ...
      <header class="v2-head" appReveal>
        ...
        <div class="crit">
          ...
          <div class="crit__i card">
            ...
            <span class="crit__v"
              >{{ diasCierre }}<span class="muted" style="font-size:15px"> días</span></span
            >
      ...
      <div class="v2-grid">
              ...
              @if (creditos > 0) {
                <a class="feed__item feed__item--urgent card" routerLink="/n/equipo">
                  ...
                  <div class="feed__body">
                    ...
                    <span class="tiny"
                      >Sin tu aprobación, esas consultoras no pueden pasar pedido.</span
                    >
                  </div>
        ...
        <aside class="v2-aside">
          ...
          <a class="card par" routerLink="/n/carrera" appReveal>
            <div class="par__cover">
              <img src="media/punta-cana.jpg" alt="" aria-hidden="true" />
            </div>
            <div class="par__body">
          ...
          @if (perfil().capacidades.equipo) {
            ...
            <div class="card pad fnd" appReveal [revealDelay]="80">
              <h3 class="v2-h" style="font-size:15px">
                <app-icon name="users" [size]="16" /> {{ perfil().norte.titulo }}
              </h3>
              <p class="tiny" style="margin:0 0 8px">{{ perfil().norte.detalle }}</p>
              <a class="nlink" routerLink="/n/carrera">Ver mi carrera →</a>
            </div>
          }
...
export class InicioN {
  ...
  protected readonly areas = computed(() => {
    ...
    if (p.capacidades.equipo) {
      out.push({
        titulo: 'Mi equipo',
        icon: 'users',
        tone: 'warn',
        resumen: `${p.hijas ? Math.round((p.hijas.enA / p.hijas.total) * 100) : 0}% hijas en Cuadrante A · ${this.creditos} créditos por aprobar`,
        ruta: '/n/equipo',
      });
    }
    out.push({
      ...
      icon: 'star',
      tone: 'info',
      resumen: `PAR+ Estrella ${p.par.estrella}${p.auto ? ` · auto ${p.auto.avance}%` : ''}`,
      ruta: '/n/carrera',
    });
    return out;
  });
