 ...
 *
 * El cuerpo es común a las tres expresiones; solo cambia la cara, así el
 * personaje se siente "vivo" sin duplicar el dibujo.
 */
@Component({
  ...
  template: `
    ...
    >
      ...
      <!-- sombra de apoyo -->
      <ellipse cx="48" cy="87" rx="23" ry="5" fill="#222" opacity="0.08" />
