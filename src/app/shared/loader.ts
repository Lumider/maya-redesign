  ...
  styles: [
    `
      ...
      @keyframes ld-letter-in {
        from {
          opacity: 0;
          transform: translateY(24%) scale(0.86);
        }
        to {
          opacity: 1;
      ...
      .ld__count--out {
        animation: ld-count-out 0.45s cubic-bezier(0.4, 0, 0.2, 1) forwards;
      }
...
export class Loader implements OnInit, OnDestroy {
  ...
  private finish(): void {
    ...
    // Secuencia escalonada: 1) imágenes colapsan → 2) wordmark sale letra por
