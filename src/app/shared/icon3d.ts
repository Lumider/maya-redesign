    ...
    >
      @switch (name()) {
        @case ('bag') {
          ...
          <circle cx="36" cy="40" r="3" fill="#862d09" />
          <circle cx="60" cy="40" r="3" fill="#862d09" />
        ...
        @case ('chart') {
          ...
          <path d="M22 56l5-4h14l-5 4z" fill="#ffe2d3" />
          <path d="M36 56l5-4v24l-5 4z" fill="#ffa87c" />
          <!-- barra 2 -->
          <rect x="42" y="44" width="14" height="36" rx="3" fill="url(#chB)" />
          <path d="M42 44l5-4h14l-5 4z" fill="#ffbe9d" />
          <path d="M56 44l5-4v36l-5 4z" fill="#e85d27" />
          <!-- barra 3 -->
        ...
        @case ('gift') {
          ...
          <rect x="43.5" y="34" width="9" height="46" rx="3" fill="#fff3ed" />
          <path d="M48 33c-9-11-21-3-11 4 4 3 11-1 11-4Z" fill="#d94e15" />
          <path d="M48 33c9-11 21-3 11 4-4 3-11-1-11-4Z" fill="#ff6f3c" />
          <circle cx="48" cy="34" r="3.4" fill="#ffe2d3" />
        ...
        @case ('rocket') {
          ...
          <circle cx="48" cy="38" r="4" fill="#ffe2d3" />
          <circle cx="46.4" cy="36.4" r="1.5" fill="#fff" />
          <!-- propulsor y llama -->
          <path d="M42 62h12l-2 6h-8Z" fill="#b8400c" />
          <path d="M48 70c5 5 4 10 0 16-4-6-5-11 0-16Z" fill="#ff8a3d" />
          <path d="M48 72c3 3 2.5 7 0 11-2.5-4-3-8 0-11Z" fill="#f5b942" />
          <!-- destellos -->
          <path d="M22 26l1.4 3.6L27 31l-3.6 1.4L22 36l-1.4-3.6L17 31l3.6-1.4Z" fill="#ffc4a8" />
          <circle cx="74" cy="22" r="2.4" fill="#ffc4a8" />
        }
        @case ('heart') {
          <defs>
        ...
        @case ('cap') {
          ...
          <circle cx="48" cy="36" r="3" fill="#ffc4a8" />
        }
      }
    </svg>
  `,
